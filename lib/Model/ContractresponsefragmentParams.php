...
/**
 * ContractresponsefragmentParams Class Doc Comment
 *
 * @category Class
 * @package  tpn
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class ContractresponsefragmentParams implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'contractresponsefragment_params';
    ...
    public function setDuration($duration)
    {
        ...
        if (!is_null($duration) && ($duration < 3600)) {
            throw new \InvalidArgumentException('invalid value for $duration when calling ContractresponsefragmentParams., must be bigger than or equal to 3600.');
        }
    ...
    public function setBandwidth($bandwidth)
    {
        ...
        if (!is_null($bandwidth) && ($bandwidth > 10000000)) {
            throw new \InvalidArgumentException('invalid value for $bandwidth when calling ContractresponsefragmentParams., must be smaller than or equal to 10000000.');
        }
        if (!is_null($bandwidth) && ($bandwidth < 1000)) {
            throw new \InvalidArgumentException('invalid value for $bandwidth when calling ContractresponsefragmentParams., must be bigger than or equal to 1000.');
        }
