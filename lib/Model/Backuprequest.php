...
/**
 * Backuprequest Class Doc Comment
 *
 * @category Class
 * @package  tpn
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class Backuprequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'backuprequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['vnf_uuid'] === null) {
            $invalidProperties[] = "'vnf_uuid' can't be null";
        }
     ...
     * Sets vnf_uuid
     *
     * @param string $vnf_uuid vnf_uuid
     *
     * @return $this
     */
     ...
     *
     * @param string|null $replace_backup_uuid replace_backup_uuid
     *
     * @return $this
     */
